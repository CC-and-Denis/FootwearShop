 ...
 */
final class Version20240919125558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, buyer_id INT NOT NULL, vendor_id INT NOT NULL, rated_product_id INT NOT NULL, rating INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_D88926226C755722 (buyer_id), INDEX IDX_D8892622F603EE73 (vendor_id), INDEX IDX_D8892622C9BB668E (rated_product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
